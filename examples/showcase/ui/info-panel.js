...
AFRAME.registerComponent('info-panel', {
  init: function () {
    ...
    this.movieInfo = {
      profileButton: {
        title: 'Manage your DAOs',
        imgEl: document.querySelector('#profileMovieImage'),
        description: 'Manage here all the DAOs you are member and prepare your day in the metaverse with no effort just dragging and dropping.'
      },
      rightButton: {
        title: 'Create your DAOverse',
        imgEl: document.querySelector('#rightMovieImage'),
        description: 'Create, shrink, expand, conqueer your new DAOverse! Choose how many tiles you want it to be, who will be your DAO members and inhabitants and the style!'
      },
      kazetachinuButton: {
